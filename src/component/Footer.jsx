    ...
    <footer className="py-5 bg-dark text-white">
      ...
      <div className="d-flex justify-content-between py-4 my-4 border-top">
        ...
        <ul className="list-unstyled d-flex">
          <li className="ms-3"><a className="link-dark" href="#"><svg className="bi" width="24" height="20"><use href="#twitter"></use></svg></a></li>
          <li className="ms-3"><a className="link-dark" href="#"><svg className="bi" width="24" height="20"><use href="#instagram"></use></svg></a></li>
          <li className="ms-3"><a className="link-dark" href="#"><svg className="bi" width="24" height="20"><use href="#facebook"></use></svg></a></li>
        </ul>
      </div>
    </footer>
  );
